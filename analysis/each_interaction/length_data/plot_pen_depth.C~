...
void plot_pen_depth()
{
  ...
  for (float lambda = 3.0; lambda <=3.0; lambda = lambda + 3)
  {
    ...
    fstream file1;
    file1.open("pen_depth1_data.txt", ios::in);

    double xs1,ys1,exs1,eys1;
    //////////////////////////////////////////////////
    fstream file2;
    file2.open("pen_depth2_data.txt", ios::in);

    double xs2,ys2,exs2,eys2;
    //////////////////////////////////////////////////
    fstream file3;
    file3.open("pen_depth3_data.txt", ios::in);

    double xs3,ys3,exs3,eys3;
    //////////////////////////////////////////////////
    fstream file4;
    file4.open("pen_depth4_data.txt", ios::in);
  ...
  mg->Draw("AP");
  mg->SetTitle("Penetration Depth of Gamma Ray;Size Multiplier of Detector;Distance from source to interaction (mm)");
