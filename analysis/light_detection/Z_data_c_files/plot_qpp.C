...
void plot_qpp()
{
  ...
  fstream file1;
  file1.open("../Z_data_txt/numeion_data.txt", ios::in);
  fstream file2;
  ...
  gr->Draw("AP");
  gr->SetTitle("Charge on Pixel Plane Per Scattering process;Drift Length (mm);Number of Ionization Electrons per Scattering Process");
