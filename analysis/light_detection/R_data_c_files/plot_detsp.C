void plot_detsp()
{
  ...
  fstream file;
  file.open("../R_data_txt/det_sp_data.txt", ios::in);
  ...
  gr->Draw("AP");
  gr->SetTitle("Number of Scintillation Photons;Radius of Detector (mm);Number of Photons Produced by Scintillation");
  c1->SaveAs("Detected_sp_plt.png");
}
