...
void plot_qpp()
{
  ...
  fstream file1;
  file1.open("../A_data_txt/numeion_data.txt", ios::in);
  fstream file2;
  file2.open("../A_data_txt/enum_data.txt", ios::in);
  ...
  gr->Draw("AP");
  gr->SetTitle("Charge on Pixel Plane Per Scattering process;Radius of PMT (mm);Number of Ionization Electrons per Scattering Process");
