  ...
  while(1)
    {
      files_file >> filename;
      cout<<filename<<endl;
       string infilename = "./../build/total_root_files/" + filename;
	...
	if (myfile)
	  {
	    ...
	    TH1I *num_sp = new TH1I("num_sp", "Number of Scintilation photons", 25, 0, 1000);
	    ...
	    TH1I *det_sp = new TH1I("det_sp", "Number of Detected Scintillation Photons", 25, 0, 50);
