   ...
   fWinMaterial(0), fSSMaterial(0)
{
  ...
  fAbsorberRadius   = 0.00762*m;
  fZAbsorber = (0.144018+0.03)*m;
...
void DetectorConstruction::DefineMaterials()
{
  ...
  fSSMaterial = nist->FindOrBuildMaterial("G4_Ar");
  //Defines the world to be made out of liquid argon
  fWorldMaterial = nist->FindOrBuildMaterial("G4_lAr");
...
G4VPhysicalVolume* DetectorConstruction::ConstructCalorimeter()
{
  ...
  fSolidWorld = new G4Tubs("World",                        // its name
			   0.,fWorldSizeR,fWorldSizeZ/2.+0.075*m+fAbsorberThickness,0.,twopi);// its size
  ...
  fSolidAbsorber = new G4Tubs("Absorber",fAbsorberRadius,
                              fWorldSizeR*0.9525*mm,
  ...
  fPhysiAbsorber = new G4PVPlacement(0,
                                     G4ThreeVector(0.,0.,-fWorldSizeZ/2-fAbsorberThickness/2),
                                     "Absorber",
                                     fLogicAbsorber,
                                     fPhysiWorld,
                                     false,
   ...
   fPhysiAbsorber2 = new G4PVPlacement(0,
                                     G4ThreeVector(0.,0.,fWorldSizeZ/2+fAbsorberThickness/2),
                                     "Absorber2",
                                     fLogicAbsorber,
                                     fPhysiWorld,
  ...
  fSolidWin = new G4Tubs("Window", 0,
			 fAbsorberRadius,
			 fAbsorberThickness/2,
			 0.0,twopi);

  fLogicWin = new G4LogicalVolume(fSolidWin,
				  fWinMaterial,
				  "Window");

  fPhysiWin = new G4PVPlacement(0,
				G4ThreeVector(0.,0.,-fWorldSizeZ/2-fAbsorberThickness/2),
				"Window",
				fLogicWin,
				fPhysiWorld,
  ...
  fSolidSS = new G4Tubs("Sample Space", 0,
			fWorldSizeR,
			0.075/2*m,
			0.0,twopi);
  ...
  fPhysiSS = new G4PVPlacement(0,
			       G4ThreeVector(0,0,-0.075*m-fWorldSizeZ/2+fAbsorberThickness/4),
			       "Sample Space",
			       fLogicSS,
			       fPhysiWorld,
			       false,
